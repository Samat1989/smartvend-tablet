...
Вкладка «Пользователи» и кнопка «Добавить устройство» у не-суперадминов скрыты
косметически — настоящие проверки живут внутри `admin-create-user`,
